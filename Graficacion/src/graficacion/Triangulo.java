...
public class Triangulo extends Figuras {
    ...
    public Triangulo(VerticesT v0, VerticesT v1, VerticesT v2, Color _color)
    {
        color = _color;        
    ...
    public void dibujar(Rastreador r)
    {
...
protected boolean inicializarTriangulo(Rastreador r)
    {
        if (edge == null) edge = new Borde[3];
        
        /*
            Compute the three edge equations
        */
        edge[0] = new Borde(v[0], v[1]);
        edge[1] = new Borde(v[1], v[2]);
        edge[2] = new Borde(v[2], v[0]);
